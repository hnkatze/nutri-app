      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-7'>
        ...
        <Card className='col-span-3'>
          <CardHeader>
            ...
            <CardDescription>
              Tienes 3 citas programadas para hoy
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <CardContent>
          <div className='space-y-8'>
            <div className='flex items-center'>
              ...
              <div className='ml-auto font-medium'>Progreso: 60%</div>
            </div>
            <div className='flex items-center'>
              <Avatar className='h-9 w-9'>
              ...
              <div className='ml-auto font-medium'>Progreso: 75%</div>
            </div>
            <div className='flex items-center'>
              <Avatar className='h-9 w-9'>
              ...
              <div className='ml-auto font-medium'>Progreso: 90%</div>
            </div>
          </div>
        </CardContent>
      </Card>
